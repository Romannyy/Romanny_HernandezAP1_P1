        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EntradasDetalle_EntradasHuacales_IdEntrada",
                        column: x => x.IdEntrada,
                        principalTable: "EntradasHuacales",
                        principalColumn: "IdEntrada",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EntradasDetalle_TiposHuacales_TipoId",
                        column: x => x.TipoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EntradasDetalle_IdEntrada",
                table: "EntradasDetalle",
                column: "IdEntrada");

            migrationBuilder.CreateIndex(
                name: "IX_EntradasDetalle_TipoId",
                table: "EntradasDetalle",
                column: "TipoId");
        }
